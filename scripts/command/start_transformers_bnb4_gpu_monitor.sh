...
echo "启动 Transformers BNB4 GPU 监控，数据写入：${RESULT_DIR}/gpu_metrics.csv"
...
python scripts/gpu_monitor.py \
  --output results/transformers_bnb4_nohup_8192fix/gpu_metrics.csv \
  --interval 1 \
  --label transformers_bnb4_8192fix
